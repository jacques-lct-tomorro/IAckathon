        ...
        <div className="oroscope-logo__mark">
          <svg viewBox="0 0 160 140" role="presentation">
            ...
            <g transform="translate(80,70)">
              <circle
                className="oroscope-logo__satellite oroscope-logo__satellite--1"
                r="6"
                fill="#4ade80"
              />
            </g>
            <g transform="translate(80,70)">
              <circle
                className="oroscope-logo__satellite oroscope-logo__satellite--2"
                r="5"
                fill="#4ade80"
                opacity="0.8"
              />
            ...
            <g transform="translate(80,70)">
              <circle
                className="oroscope-logo__satellite oroscope-logo__satellite--3"
                r="4"
                fill="white"
                opacity="0.4"
              />
